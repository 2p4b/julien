...
// Copied from https://github.com/flosch/pongo2-addons/blob/master/filters.go
// Because the auto import wasn't working
import (
	"bytes"
	"errors"
	"fmt"
...
func PogoInit() {
	...
	pongo2.RegisterFilter("uppercase", filterUpercase)
...
func filterUpercase(in *pongo2.Value, param *pongo2.Value) (*pongo2.Value, *pongo2.Error) {
