...
func Find(ppath string, index ...string) (*Theme, error) {
	yamler := driver.Yaml{}
...
func (tmpl *Theme) Engine(reload bool) fiber.Views {
...
func (tmpl *Theme) Get(key string, defaultValue ...interface{}) interface{} {
...
func (tmpl *Theme) GetString(key string, defaultValue ...string) string {
...
func (tmpl *Theme) GetInt(key string, defaultValue ...int) int {
...
func (tmpl *Theme) GetInt64(key string, defaultValue ...int64) int64 {
